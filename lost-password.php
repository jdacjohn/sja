...
if (isset($_POST) && !empty($_POST['lost_user_email']) && (filter_var($_POST['lost_user_email'], FILTER_VALIDATE_EMAIL)))
	...
	if(mysql_num_rows($result)==0)
	...
	else
		{
			...
			send_mail('admin@sja.us', $_POST['lost_user_email'], 'St. Joseph Academy - Your New Password', 'Your username is: '.$lost_user_login.' and your password is: '.$lost_user_pass);
	...
	<fieldset>
		...
		<ul><li><input type="text" name="lost_user_email" id="lost_user_email" value="<?php if(isset($_POST['lost_user_email']) != ''){ echo $_POST['lost_user_email']; } else {} ?>"><div id="checkhint"></div></li>
...
{
echo '<p>Please <a href="/login/?logout">Log Out</a> before resetting your password.</p>';
}
