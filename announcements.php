...
if(mysql_num_rows($result)==0)
	...
	while($row = mysql_fetch_array($result))
		{ $announce_id=$row['announce_id']; $announce_name=$row['announce_name']; $announce_date=convert_date($row['announce_date']); $announce_full = strip_tags(html_entity_decode($row['announce_full'], ENT_QUOTES, 'utf-8'),$allowed_html);
